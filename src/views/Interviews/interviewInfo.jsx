...
export const InterviewInfo = () => {
  return (
    <>
      ...
      >
        <div className="flex overflow-x-auto p-4 interview-info">
          <div style={{ flex: '0 0 auto', marginRight: '1rem', maxWidth: 600 }}>
            <Card className="!p-0 border-solid border-2 border-[#e5e7eb]">
              <Row>
                ...
                <Col xs={24} md={14}>
                  <Row gutter={[16, 16]}>
                    ...
                    <Col span={12}>
                      <span className="font-medium">Interviewer: {' '}
          ...
          <div style={{ flex: '0 0 auto', marginRight: '1rem', maxWidth: 600 }}>
            <Card className="!p-0 border-solid border-2 border-[#e5e7eb]" style={{ minWidth: '300px' }}>
              <Row>
                <Col span={10} className="flex-col">
                  <div className="h-20 w-20 rounded-full m-auto">
