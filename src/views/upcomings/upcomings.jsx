        ...
        <>
         <Row>
             ...
             <Col span={24} className="flex flex-row justify-between">
                 <h1 className='mt-1 text-base font-medium'>Upcomings</h1>
             ...
             <Col span={13}>
               <h1 className='font-normal text-md'>Interview with designer</h1>
               <span className='text-md font-light'>Created by <span className="text-[#0B74AD] font-normal">Stella</span></span>
             ...
             <Col span={13}>
               <h1 className='font-normal text-md'>Interview with PMO</h1>
               <span className='text-md font-light'>Created by <span className="text-[#0B74AD] font-normal">Stephen</span></span>
               <h1 className='text-small mt-1 font-light'>10 A.M to 11 A.M</h1>
             </Col>
             <Col span={5}>
               <Button className='ml-1' type='primary'>Details</Button>
             ...
             <Col span={13}>
               <h1 className='font-normal text-md'>Interview with Net. Admin</h1>
               <span className='text-md font-light'>Created by <span className="text-[#0B74AD] font-normal">Stella</span></span>
               <h1 className='text-small mt-1 font-light'>10 A.M to 11 A.M</h1>
             </Col>
             <Col span={5}>
